 ...
 Collection.prototype = {
     ...
     equals: function(collection) {
         if(!(collection instanceof Collection)) return false;
             ...
             if(this.elements.length != collection.elements.length) return false;
             for(var i = 0; i < this.elements.length; i++) {
                 if(this.elements[i] instanceof Collection && collection.elements[i] instanceof Collection) {
                     if(!this.equals(collection.elements[i])) return false;
                 } else if (this.elements[i] != collection.elements[i]) {
                     return false;
                 }
