 ...
 Collection.prototype = {
     ...
     addAll: function() {
         ...
         for(var i = 0; i < args.length; i++) {
             ...
             if(this.add(args[i])) result = true;
         }
     ...
     contains: function(item) {
         if(item instanceof Collection) item = item.getAll();
     ...
     containsAll: function() {
         ...
         for(var i = 0; i < args.length; i++) {
             ...
             if(!this.contains(args[i])) return false;
         }
     ...
     removeAll: function() {
         ...
         for(var i = 0; i < args.length; i++) {
             ...
             if(this.remove(args[i])) result = true;
         }
     ...
     keep: function() {
         ...
         for(var i = 0; i < diff.length; i++)
             if(this.remove(diff[i])) result = true;
