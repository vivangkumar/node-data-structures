 ...
 Collection.prototype = {
     ...
     equals: function(collection) {
         if(!(collection instanceof Collection)) return false;
             ...
             if(this._elements.length != collection.getAll().length) return false;
             for(var i = 0; i < this._elements.length; i++) {
                 if(this._elements[i] instanceof Collection && collection.getAll()[i] instanceof Collection) {
                     if(!this.equals(collection.getAll()[i])) return false;
                 } else if (this._elements[i] != collection.getAll()[i]) {
                     return false;
                 }
